...
public class BlindBoxController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/balatro/blindPickPanels.fxml"));
        try {
            //loader.setRoot(smallBlind);
            //loader.setControllerFactory(param -> null); // deaktiviert neuen Controller
            loader.load();
            smallBlindController = loader.getController(); // Hier bekommst du den Controller
